...
#logo
logo = pyfiglet.figlet_format('*      𝐁𝐎      *')
print(X+logo)
print('  ')
print(A+'═'*60)
print('  ')
...
try:
    ...
    bot_token = '6472662595:AAERk8xwGUDnVd7ajWWoDuAvnwXKzlkfaFY'
    DEVLOO = '6264668799'
    MAX_ACCOUNTS = int('30')
    user_bot = 'ee0obot'
    id_bot = int('6264668799')
...
async def start(event):
    ...
    if sender.id == DEVELOPER_ID:
        ...
        [Button.inline('⬩ مسح بيانات البوت ⬩', 'format')],    
         [Button.inline('༺ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐎 🔱 ༻', 'button0')]
        ]
